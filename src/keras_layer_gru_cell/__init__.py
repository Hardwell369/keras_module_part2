...
friendly_name = "GRUCell - Keras"
doc_url = "https://keras.io/api/layers/recurrent_layers/gru_cell/"
cacheable = False
...
def run(
    ...
    if debug:
        logger.debug(f"{init_params=}, {call_params=}")

    layer = keras.layers.GRUCell(**init_params)(**call_params)
