...
friendly_name = "GRU - Keras"
doc_url = "https://keras.io/api/layers/recurrent_layers/gru/"
cacheable = False
...
def run(
    ...
    init_params = dict(
        ...
        use_cudnn=(True if use_cudnn == "True" else False if use_cudnn == "False" else "auto"),
    )
    call_params = dict()
    ...
    layer = keras.layers.GRU(**init_params)(**call_params)
